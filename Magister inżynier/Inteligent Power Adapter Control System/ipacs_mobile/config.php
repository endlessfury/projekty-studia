                    ...
                    <?php foreach($hcas_adapters as $adapters) { ?>
                        <div class="subPanelConfigAdapter">
                            <?php 
                                ...
                                if ($_SESSION['user_permission'] == 2) echo '&nbsp&nbsp•&nbsp<a href="#?adapter_id='.$adapters['adapter_id'].'" class="configLink">Przypisz adres (do dodania)</a><br>';
                        ...
                        <div class="subpanelConfig_2" style="";>
                            ...
                            <div style="font-size:15px;">';
                                ...
                                echo '<form action="user.php" method="POST">
                                    ...
                                    <input type="text" name="username" class="logIn" maxlength="10" style="margin-top:5px;margin-bottom:5px;width: 140px;"><br>
                                    Podaj hasło użytkownika:<br>
                                    <input type="password" name="password" class="logIn" style="margin-top:5px;margin-bottom:5px;width: 140px;"><br>
                                    Powtórz hasło:<br>
                                    <input type="password" name="password_2" class="logIn" style="margin-top:5px;margin-bottom:5px;width: 140px;"><br>
                    ...
                    <div class="subpanelConfig_2" style="height:100%";>
                        ...
                        <div style="font-size:15px;">
                            <form action="change_password.php" method="POST">
                                Podaj nowe hasło:<br>
                                <input type="password" name="newPassword" class="logIn" style="margin-top:5px;margin-bottom:5px;width: 140px;"><br>
                                Powtórz nowe hasło:<br>
                                <input type="password" name="newPassword_2" class="logIn" style="margin-top:5px;margin-bottom:5px;width: 140px;"><br>
                    ...
                    <div class="subpanelConfig_2" style="">
                        ...
                        <div style="font-size:15px;">
                            <form action="refresh.php" method="POST">
                                ...
                                <input type="text" name="refresh_timeout" maxlength="4" size="4" class="logIn" style="margin-top:5px;margin-bottom:5px;" palceholder="sek">&nbsp<br>
