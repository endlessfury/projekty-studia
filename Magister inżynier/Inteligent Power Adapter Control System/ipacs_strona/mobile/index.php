    ...
    <div id="container">
        ...
        <div class="panel">
            <div class="subPanelTop"><center>
                ...
                <a class="logOut" href="logout.php" style="font-size: 16px;line-height: 60px;margin-bottom: 10px;width: 90%;padding: 0;">Wyloguj się <font color="#7c7c7c"><?php if ($_SESSION['logged'] == true) echo $_SESSION['user_login']; ?></font></a>
                </center></div>
        </div>
